...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp # alloc space
  400f02:	48 89 e6             	mov    %rsp,%rsi
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers> # must six num
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # 1st num must be 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34> # jump
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax #now eax is 1
  ...
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx   # rbx is 2st num
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp # num24 is the end of six num
...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp  # alloc space 24
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax # give cin num
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # smaller than 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # jump unsigned above
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # 2st num = eax
